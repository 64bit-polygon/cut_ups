...
export const QuillBtn = ({
  ...
  return (
    <div className={cn(styles.btnWrap, positionClasses)}>
      <button
        type="button"
        className={cn(quillClasses, styles.button)}
        value={value}
        id={`quillBtn_${iconName}`}
        onClick={onClick}
        data-iconname={iconName}
      />
      <label
        className={cn("hideText", styles.label, positionClasses)}
        htmlFor={`quillBtn_${iconName}`}
      >
        {children}
      </label>
